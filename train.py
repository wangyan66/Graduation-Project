...
class MyCorpus:
    def __iter__(self):
        ...
        for line in open('text.txt'):
            # print(gensim.utils.simple_preprocess(line, max_len=30))
            yield line.split()
...
# hh=gensim.utils.simple_preprocess("usdad12",deacc=False)
# print("iasda11 asdzxc22".split())
# print(isinstance(hh,list))
